...
class C_Scint_Mouse_Click_Hook():
	...
	def RegHook(self):
		...
		def HOOK_MyWndProc(hwnd, msg, wparam, lparam):
			...
			elif (console.editor.getProperty(self.editorprop_csdlc_on) == self.feature_on and \
			...
			elif (console.editor.getProperty(self.editorprop_asdlc_on) == self.feature_on and \
