...
i_option_right_click						= 1 # right-click keeps current selection and caret position
...
t_option_key = ("SDLC", "CSDLC", "ASDLC", "ARC", "RC", "GBR", "GQT", "CLPCOPY", "CONCOPY", "TOGMBOX", "WORDCHR")
...
t_option_value = (
	...
	i_option_get_brackets, i_option_get_quotes, \
