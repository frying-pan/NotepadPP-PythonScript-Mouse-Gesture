...
class C_Find_OutRange():
	...
	def FindText_MatchingBrackets_OutRange(self, curedit, i_start, i_end, b_angle):
	...
	def RE_MatchingBrackets_OutRange_InRange(self, curedit, i_start, i_end, i_min, i_max, b_angle):
...
class C_Extend_Sel_From_Caret():
	...
	def ExtendSel_To_Brackets(self, curedit, i_sel_start, i_sel_end, b_angle, b_get_brackets, b_clp_copy, b_con_copy):
		...
		t_brackets = self.o_find_outrange.FindText_MatchingBrackets_OutRange(curedit, i_sel_start, i_sel_end, b_angle)
